...
# Insert the data
sqlite $database "insert into $app (name,value,comment) values ('AIRSONIC_SUBDOMAIN', '$AIRSONIC_SUBDOMAIN', 'Subdomain for adguard-one');"

# Replace the variables
cp "./docker-compose.yml" "./docker-compose-final.yml"
sed -i "s/AIRSONIC_SUBDOMAIN/$AIRSONIC_SUBDOMAIN/g" docker-compose-final.yml
