...
echo "BAZARR_SUB=bazarr" >> /root/vars.sh
echo "BEEHIVE_SUB=beehive" >> /root/vars.sh
echo "BEETS_SUB=beets" >> /root/vars.sh
echo "BLENDER_SUB=blender" >> /root/vars.sh
...
echo "EXATORRENT_SUB=exatorrent" >> /root/vars.sh
...
dir_array+=("/var/data/audacity" "/var/data/audacity/config")
dir_array+=("/var/data/babybuddy" "/var/data/babybuddy/config")
